...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 py-md-4 scroll">
                    ...
                    <div class="card">
                            ...
                            <ul class="nav nav-tabs mt-2" id="xii" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="xii-tab-2" data-mdb-toggle="tab" href="#xii-tabs-2"
                                        role="tab" aria-controls="xii-tabs-2" aria-selected="false">Humanities</a>
                                </li>
                                <li class="nav-item" role="presentation">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="xii-content">
                                ...
                                <div class="tab-pane fade" id="xii-tabs-2" role="tabpanel" aria-labelledby="xii-tab-2">
                                    @include('user.routine.tables.hum_xii')
                                </div>
                                <div class="tab-pane fade" id="xii-tabs-3" role="tabpanel" aria-labelledby="xii-tab-3">
