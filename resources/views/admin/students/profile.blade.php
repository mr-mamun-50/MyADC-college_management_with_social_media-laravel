                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle"
                                src="{{ asset('images/students') . '/' . $student->photo }}" alt="User profile picture">
                        </div>

                        <h3 class="profile-username text-center">{{ $student->name }}</h3>
                        <p class="text-muted text-center"><a href="tel:{{ $student->phone }}">{{ $student->phone }}</a>
                        </p>
                        ...
                        <a href="mailto:{{ $student->email }}" class="btn btn-primary btn-block" target="blank">
                            <b>Send Mail</b></a>
                    </div>
                    <!-- /.card-body -->
                </div>
